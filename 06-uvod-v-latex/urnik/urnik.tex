...
\begin{enumerate} 
   ...
   \(srečanja_i\), ki ga sestavlja \(predmet_ij\), profesor, ki ta predmet predava,
  ...
  \item Če je trenutna cena boljša od najboljše dosedanje, potem najboljša dosedanja
   ...
   vstavljanja, da bomo \(predmet_ij\) na koncu vstavili v termin z najboljšo
   ceno vstavljanja.

   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo \(srečanje_j\)
