...
% začetek povzetka
\begin{abstract}
V članku so predstavljeni nekateri postopki za avtomatsk o izdelavo urnikov. Opisani so
...
\begin{enumerate} 
   ...
   \(\text{srečanja}_i\), ki ga sestavlja \(\text{predmet}_ij\), profesor, ki ta predmet predava,
  ...
  \item Če je trenutna cena boljša od najboljše dosedanje, potem najboljša dosedanja
   ...
   vstavljanja, da bomo \(\text{predmet}_ij\) na koncu vstavili v termin z najboljšo
   ceno vstavljanja.
